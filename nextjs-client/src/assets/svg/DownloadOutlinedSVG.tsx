...
const DownloadOutlinedSVG: React.FC = () => (
    <svg width="16" height="16" fill="#1f1f1f" viewBox="64 64 896 896" focusable="false" xmlns="http://www.w3.org/2000/svg">
...
export default DownloadOutlinedSVG;
