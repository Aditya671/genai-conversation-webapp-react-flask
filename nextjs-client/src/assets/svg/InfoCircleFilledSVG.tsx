...
const InfoCircleFilledSVG: React.FC = () => (
    <svg width="50" height="50" fill="#cacaca" viewBox="64 64 896 896" focusable="false" xmlns="http://www.w3.org/2000/svg">
...
export default InfoCircleFilledSVG;
