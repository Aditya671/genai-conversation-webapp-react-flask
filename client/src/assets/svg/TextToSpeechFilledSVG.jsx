export const TextToSpeechFilledSVG = () => (
    <svg width="18" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        `}</style>
        <rect x="3" y="4" width="16" height="24" rx="2" ry="2" fill="none" stroke="#000" stroke-width="2"/>
        <line x1="5" y1="8" x2="17" y2="8" stroke="#000" stroke-width="1.2"/>
        <line x1="5" y1="12" x2="17" y2="12" stroke="#000" stroke-width="1.2"/>
